...
## 三、知识区上传什么
Skill 内置当前规则和 `1.4` 模板。业务人员不需要上传模板或工具包；部长只需发送飞书月报链接。工具包仅在初审报告明确标注“条件必须”时才使用。
...
| 输出老板一页纸、主管整改版、重做通知 | `shuchu-muban.md`、`jiaofu-xingtai.md` |
| 整改后复审 / 重做后复核 | `fushen-jianhua-rukou.md`、`fushen-zhenggai.md` |
| 部门填报 Word 模板 | `xiaoshou-yuebao-muban-v1.4.docx` |
| 条件化补充工具包 | `xiaoshou-yuebao-gongjubao-v1.4.xlsx` |
